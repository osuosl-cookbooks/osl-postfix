...
default['osl-postfix']['main']['smtpd_data_restrictions'] = 'reject_unauth_pipelining'
default['osl-postfix']['main']['smtpd_discard_ehlo_keywords'] = 'chunking,silent-discard'
...
default['osl-postfix']['main']['smtpd_tls_security_level'] = 'none'
...
when '10.162.136.1', '128.193.126.193', '148.100.110.1', '148.100.84.1', '10.6.4.1'
